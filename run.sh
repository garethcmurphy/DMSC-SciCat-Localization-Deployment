...
kubectl --namespace=dev delete -f mongo.yaml
kubectl --namespace=dev delete -f rabbit.yaml
...
for file in $NS_DIR; do
  ...
  export LOCAL_ENV="$ns"
  kubectl --namespace=dev apply -f mongo.yaml
...
helm repo add incubator http://storage.googleapis.com/kubernetes-charts-incubator
  ...
  kubectl --namespace=dev apply -f rabbit.yaml
